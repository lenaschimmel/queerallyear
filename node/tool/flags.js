exports.flagmap = function (lines, c, flagName, colorDomain = false) {
    ...
    if (lines == 3) {
        if(flagName == "Inter")
            ...
            return { "Q0": c[0], "U0": c[1], "E0": c[2], "E1": c[3], "R0": c[3], "A0": c[1], "L0": c[2], "L1": c[3], "Y0": c[0], "E2": c[1], "A1": c[2], "R1": c[3] };
        else if (c.length == 5)
            return { "Q0": c[0], "U0": c[0], "E0": c[1], "E1": c[2], "R0": c[4], "A0": c[1], "L0": c[2], "L1": c[3], "Y0": c[1], "E2": c[2], "A1": c[3], "R1": c[4] };
        else if (c.length == 7)
            return { "Q0": c[0], "U0": c[1], "E0": c[2], "E1": c[3], "R0": c[4], "A0": c[2], "L0": c[3], "L1": c[4], "Y0": c[3], "E2": c[4], "A1": c[5], "R1": c[6] };
        else if (c.length == 8)
            return { "Q0": c[2], "U0": c[3], "E0": c[4], "E1": c[5], "R0": c[6], "A0": c[1], "L0": c[0], "L1": c[1], "Y0": c[4], "E2": c[5], "A1": c[6], "R1": c[7] };
    }
}
